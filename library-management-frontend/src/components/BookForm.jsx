...
function BookForm() {
  ...
  if (loading) return (
    <div className="flex items-center justify-center h-screen w-screen bg-gray-900 text-gray-200">
  ...
  return (
    <div className="w-full min-h-screen bg-gray-900 text-gray-200 flex flex-col">
      {/* Main Container */}
      ...
      {/* Footer */}
      <div className="w-full bg-gray-900 border-t border-gray-700 py-6 text-center text-gray-400">
